          ...
          <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href='https://www.lankaelephants.org/'
                  target='_blank'
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href='https://www.facebook.com/theglobalelephantproject/'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  Facebook
                </Footer.Link>
                <Footer.Link href='https://www.youtube.com/theelephantproject'>Youtube</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
